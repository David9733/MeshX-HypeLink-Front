...
| **서브관리자** | 전체 매장 현황 조회, 발주 승인, 배송 기사 배정, POS 상태 점검, 고객·매출 분석, 프로모션·쿠폰 생성·관리, 공지 발송, 메신저, AS 처리 |
| **가맹점** | 내 매장 재고 조회, 발주 요청, AS 신청, 메신저, 프로모션·공지 조회 |
| **POS 단말기** | 상품 선택·결제(일반/카드/회원), 결제 내역 조회, 공지 조회 |
