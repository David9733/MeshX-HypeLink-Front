...
| **Discord** | 무료로 음성·텍스트 채널을 목적별로 분리 가능하며 화면 공유·알림 연동 등 개발팀 협업에 필요한 기능을 추가 설치 없이 사용 가능<br>템플릿 기능을 활용해 채팅방 구조(채널·카테고리)를 프로젝트 성격에 맞게 표준화하여 팀원 간 일관된 커뮤니케이션 환경 구성 |
