...
- 매장별 POS 상태 조회 및 고장 수동 접수·처리 상태 추적
- 연령·성별·카테고리별 고객 매출 분석 및 인기상품 랭킹
- 본사–가맹점 재고 실시간 동기화 및 자동 발주
- WebSocket 기반 본사–가맹점 실시간 메신저 및 공지 전달
- POS 이상 감지 시 자동 AS 등록 및 처리 상태 조회
- PortOne SDK 기반 일반/회원 결제 및 내역 조회
